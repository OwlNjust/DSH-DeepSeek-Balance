...
window.__ModuleLoader__.load({
  ...
  factory(require) {
    ...
    const CSS = '' +
      ...
      '.dsb-stat-center{display:flex;flex-direction:column;justify-content:center;gap:3px;}' +
    ...
    function Widget() {
      ...
      kids.push(e('div', { className: 'dsb-banner ' + (peak ? 'dsb-peak-bg' : 'dsb-valley-bg'), key: 'banner' }, [
        e('div', { className: 'dsb-row', key: 'l1' }, [
          ...
          e('span', { className: 'dsb-src', key: 't' }, '北京 ' + fmtBJT(phase.startMs) + '–' + fmtBJT(phase.endMs)),
        ]),
      ...
      kids.push(e('div', { className: 'dsb-stats', key: 'stats' }, [
        e('div', { className: 'dsb-stat dsb-stat-center', key: 'bal' }, [
          e('div', { className: 'dsb-stat-l', key: 'l' }, '总余额'),
          e('div', { className: 'dsb-stat-v', key: 'v', style: { fontSize: balFontSize(bal ? fmtMoney(bal.total, bal.currency) : '—') } }, bal ? fmtMoney(bal.total, bal.currency) : '—'),
        ]),
